        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center max-w-7xl mx-auto">
            ...
            <div className="relative flex justify-center items-center">
              ...
              {/* Bottom Left */}
              <div className="absolute bottom-16 left-4 bg-white rounded-full px-4 py-2 shadow-lg border border-gray-100 flex items-center space-x-2 hover-lift">
                <Sparkles className="w-4 h-4 text-blue-500" />
                <span className="text-sm font-medium text-gray-700">AI-powered operations</span>
              </div>

              {/* Bottom Right */}
              <div className="absolute bottom-8 right-8 bg-white rounded-full px-4 py-2 shadow-lg border border-gray-100 flex items-center space-x-2 hover-lift">
